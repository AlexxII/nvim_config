...
_G.packer_plugins = {
  ...
  luaPlugin = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/luaPlugin",
    url = "/home/user/main/neovim/luaPlugin"
  },
  ["lualine.nvim"] = {
    loaded = true,
  ...
  ["oil.nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/oil.nvim",
  ...
  ["rese-pine"] = {
    ...
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/rese-pine",
  ...
  ["vim-code-dark"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-code-dark",
...
try_loadstring("\27LJ\2\n9\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0\26colorscheme rose-pine\bcmd\bvim\0", "config", "rese-pine")
